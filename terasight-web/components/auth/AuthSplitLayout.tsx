...
export function AuthSplitLayout({ title, subtitle, children }: AuthSplitLayoutProps) {
  return (
    <div className="relative flex min-h-screen">
      <div className="relative hidden w-1/2 overflow-hidden border-r border-[color:var(--color-border-1)] bg-[color:var(--color-surface-0)] lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative z-10 p-12">
          <p className="text-sm font-semibold tracking-wide text-[color:var(--color-nav-active-text)]">TeraSight</p>
