  ...
  return (
    <div className="relative">
      <button
        ...
        className="relative flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 text-foreground-muted transition hover:bg-white/5"
        ...
        <GlassPanel className="absolute right-0 top-12 z-50 w-80 overflow-hidden shadow-2xl">
          ...
          <div className="max-h-80 space-y-1 overflow-y-auto p-2">
            {notifications.map((item) => (
              <div
                key={item.id}
                className="rounded-xl border border-white/5 bg-white/[0.02] p-3 transition hover:bg-white/[0.04]"
              >
