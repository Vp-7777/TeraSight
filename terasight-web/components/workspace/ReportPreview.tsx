...
export function ReportPreview({
  ...
  return (
    <GlassPanel className="overflow-hidden" glow={result ? "emerald" : "none"}>
      ...
      <div className="border-b border-[color:var(--color-border-1)] bg-gradient-to-r from-emerald-500/8 via-transparent to-sky-500/8">
        <div className="flex items-center justify-between px-5 py-3">
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-emerald-500/15 text-sm font-bold text-[color:var(--color-nav-active-text)]">
        ...
        <div className="border-t border-[color:var(--color-border-1)] px-5 py-4">
          <div className="flex items-start gap-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[color:var(--color-surface-1)] text-[color:var(--color-nav-active-text)]">
      ...
      <div className={compact ? "space-y-4 p-5" : "space-y-5 p-6"}>
        ...
        <div className="relative overflow-hidden rounded-xl border border-[color:var(--color-border-1)] bg-gradient-to-br from-emerald-500/10 to-sky-500/5">
          <div className="aspect-[16/7] skeleton-shimmer" />
          <div className="absolute inset-0 flex items-center justify-center">
            <p className="rounded-full border border-[color:var(--color-border-1)] bg-background/60 px-3 py-1 text-xs text-foreground-muted backdrop-blur-sm">
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          {[
            ...
            <motion.div
              ...
              className="rounded-xl border border-[color:var(--color-border-1)] bg-[color:var(--color-surface-1)] p-3.5"
            >
        ...
        <div className="rounded-xl border border-emerald-500/15 bg-emerald-500/5 p-4">
          <p className="text-xs font-medium uppercase tracking-wider text-[color:var(--color-nav-active-text)]">
